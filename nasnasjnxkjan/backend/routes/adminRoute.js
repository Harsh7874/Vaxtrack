...
import { loginAdmin, appointmentCancel, addHospital, allHospitals, deleteHospital, adminDashboard, addVaccine, allVaccines, deleteVaccine, changeAvailablity, appointmentAdmin, updateHospitalVaccine, listRequestsAdmin, approveRejectRequest } from '../controllers/adminController.js';
...
adminRouter.delete("/delete-hospital/:hospitalId", authAdmin, deleteHospital)
adminRouter.get("/all-vaccines", authAdmin, allVaccines)
adminRouter.delete("/delete-vaccine/:vaccineId", authAdmin, deleteVaccine)
