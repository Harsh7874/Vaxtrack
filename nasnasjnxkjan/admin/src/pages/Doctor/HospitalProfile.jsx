...
const HospitalProfile = () => {
    ...
    const { hToken, profileData, setProfileData, getProfileData } = useContext(HospitalContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/hospital/update-profile', updateData, { headers: { hToken } })
